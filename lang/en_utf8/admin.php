...
$string['configmaxbackupsize'] = 'Do not attempt to backup courses larger than the specified size (in megabytes). Set to 0 to disable this feature.';
...
$string['maxbackupsize'] = 'Maximum backup size';
