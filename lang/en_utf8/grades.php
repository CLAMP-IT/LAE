...
$string['categorytotalname'] = 'Category total name'; // CLAMP #225 2010-06-24 cmoore
...
$string['configfrozennamesandheaders'] = 'Allows grades to scroll horizontally without losing sight of the students column, and also vertically without losing sight of the headers row.';
...
$string['configshowfeedback_col'] = 'Whether to show the feedback column in the User report.';
...
$string['configshowlettergrade'] = 'Whether to show the letter grade in the User report.';
...
$string['configshowpoints'] = 'Whether to show the points for each grade item.';
$string['configshowrange'] = 'Whether to show the range column on the User report.';
...
$string['configshowweight'] = 'Whether to show the weight column in the User report.';
...
$string['frozennamesandheaders'] = 'USE LAE Frozen Names and Headers';
$string['full'] = 'Full';
...
$string['hidetotalshowinchiddenitems'] = 'Show totals including hidden items';$string['highgradeascending'] = 'Sort by high grade ascending';
...
$string['showfeedback_col'] = 'Show feedback column';
