...
$string['configmasterallowanon'] = 'Set to \'yes\' if you want to allow anonymous forums. Teachers must still choose to allow them on a per-module basis.';
...
$string['masterallowanon'] = 'Enable Anonymous Forums';
